...
func TestE2e(t *testing.T) {
	...
	ginkgo.RunSpecs(t, "samavm e2e test suites")
}
...
var _ = ginkgo.BeforeSuite(func() {
	...
	for _, u := range uris {
		...
		samavmRPCEps = append(samavmRPCEps, rpcEP)
		outf("{{blue}}avalanche samavm RPC:{{/}} %q\n", rpcEP)
	}
...
//
// ref.
// https://github.com/onsi/ginkgo/sama/v2.0.0/formatter/formatter.go#L52-L73
