...
rm -f /tmp/samavm.genesis
/tmp/sama-cli genesis 1 /tmp/allocations.json \
--genesis-file /tmp/samavm.genesis \
...
--vm-genesis-path=/tmp/samavm.genesis \
